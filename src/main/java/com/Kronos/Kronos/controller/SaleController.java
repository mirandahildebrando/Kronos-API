...
public class SaleController {
    ...
    public ResponseEntity<APIResponse<SaleDTO>> createSale(@RequestBody SaleDTO saleDTO) {
        ...
        return ResponseEntity.status(HttpStatus.CREATED)
                .body(new APIResponse<>(sale, "Venda criada com sucesso"));
    }

    @GetMapping
    public ResponseEntity<APIResponse<List<SaleDTO>>> getAllSales() {
        return ResponseEntity.ok(
                new APIResponse<>(saleService.getAllSales(), "Lista de vendas retornada com sucesso")
        );
    }
    ...
    public ResponseEntity<APIResponse<SaleDTO>> getSaleById(@PathVariable Long id) {
        ...
        return ResponseEntity.ok(
                new APIResponse<>(sale, "Venda retornada com sucesso")
        );
    }
    ...
    public ResponseEntity<APIResponse<SaleDTO>> updateSale(
        ...
        return ResponseEntity.ok(
                new APIResponse<>(updatedSale, "Venda atualizada com sucesso")
        );
    }
    ...
    public ResponseEntity<APIResponse<Void>> deleteSale(@PathVariable Long id) {
        ...
        return ResponseEntity.ok(
                new APIResponse<>(null, "Venda deletada com sucesso")
        );
    }
}